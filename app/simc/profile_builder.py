...
def build_baseline(snapshot_raw: dict) -> str:
    """Produce baseline .simc text from stored Armory JSON.

    We rely on simc's local_json armory import: dump the equipment payload
    and let simc parse it, so we do not re-implement item stat mapping.
    """
